...
class LerobotSemanticCotrainingDataset(
    ...
    def __init__(
        ...
        for ds_meta in dataset_soup_list:
            ...
            datasets.append(
                single_dataset_class(
                    ...
                    semantic_split=task_entry["split"],
                    task_name=task,
        ...
        for dataset in datasets:
            if hasattr(dataset, "set_split_role"):
                dataset.set_split_role(split_role)
    ...
    def get_validation_dataset(self) -> "LerobotSemanticCotrainingDataset":
        if self.split_role == "val":
            return self
        return LerobotSemanticCotrainingDataset(**self._validation_init)
